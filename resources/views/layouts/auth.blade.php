...
@section('app')
    <div class="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-[#141332] px-4">
        <div class="w-full max-w-5xl bg-white dark:bg-[#1D1D41] shadow-xl rounded-lg flex overflow-hidden h-[550px]">
            <!-- Gambar Login -->
